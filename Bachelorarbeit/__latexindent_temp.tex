...
\begin{document}
  ...
  \end{tcolorbox}
    \subsection{Auswahl der Technologien}
      Dank technologischem Fortschritt gibt es heutzutage viele Möglichkeiten ein VR-System
      zu entwickeln. Es gibt Spiele-Engines, welche einem eine All-in-One-Lösung anbieten.
      Die populärsten Spiele-Engines, welche auch VR-Support anbieten, sind die Unity und
      Unreal Engine. Beide bieten eine Software an, welche mit zahlreichen Funktionen
      einhergeht, wie zum Beispiel Physik, Partikelsystem und UI. Viele dieser Funktionen
      sind schon vorprogrammiert und lassen sich einfach in das eigene Projekte einfügen
      oder auch verändern. Beide Systeme bieten auch die Möglichkeit seine aktuelle
      Anwendung für Virtual Reality bereit zu machen. Dabei werden auch die gängigsten 
      VR-Brillen unterstützt inklusive ihrer 3D-Eingabegeräten. Die Anwendung lässt sich
      letztlich auf viele verschiedene Betriebssysteme und in das Web portieren.
