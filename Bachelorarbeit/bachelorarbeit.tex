...
\begin{document}
  ...
  \section{Grundlage und Datenbasis}
    In diesem Kapitel werden die Grundlagen von Virtual Reality und die Datenbasis die
    für dieses Forschungsprojekt zur Verfügung steht erklärt. Auf Grund dieses Wissens wird in
    das nächste Kapitel übergegangen, welche sich tiefgründiger mit der Umsetzung von virtuellen
    Welten beschäftigt und diese durch Literatur untermauert. Dazu soll der aktuelle Forschungsstand
    berücksichtigt werden und dabei helfen, die ersten Prototypen zu entwickeln.
